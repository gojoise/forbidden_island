...
/*
 * Correspond à la vue de la grille/plateau de jeu
 *
 */
public class IslandView extends JPanel implements Observer{
	...
	public IslandView(Model mod,Ressources r) {
		...
		this.ress=r;//Recupère les ressources depuis fenetre
	}
	
	public Model getModele() {return this.modele;}

	/**
	 * Fonction pour dessiner la grille avec des images differentes celon les propriétés des cellules de la grille.
...
/**
 * Ce update est appellé à chaque appel de notifyObservers de model
